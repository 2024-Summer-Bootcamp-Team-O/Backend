...
from .tasks import get_gpt_answer, get_gpt_result, get_gpt_message, get_gpt_feedback
...
class GetGPTAnswerView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            result = get_gpt_answer.delay(
                choice_content, character_id, episode_id, talk_content, mz_percent
            )
